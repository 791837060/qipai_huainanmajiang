...
public class SxmjLawsFB {

    private String panshu;
    private String renshu;
    private String jiaopao = "false";
    ...
    public SxmjLawsFB(List<String> lawNames) {
...
//    }
    ...
    public String getJiaopao() {
        return jiaopao;
    }

    public void setJiaopao(String jiaopao) {
