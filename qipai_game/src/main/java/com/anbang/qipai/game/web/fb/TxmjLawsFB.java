...
public class TxmjLawsFB {
    ...
    private String baosantankehuanpai = "false";//包三滩可换牌

    public TxmjLawsFB(List<String> lawNames) {
        lawNames.forEach((lawName) -> {
            if (lawName.equals("bj")) {             //八局
                ...
                banJiesan = "true";
            } else if (lawName.equals("bstkhp")) {   //包三滩可换牌
                baosantankehuanpai = "true";
            }else {
            }
        });
    }
...
//        }
    ...
    public String getBaosantankehuanpai() {
        return baosantankehuanpai;
    }

    public void setBaosantankehuanpai(String baosantankehuanpai) {
        this.baosantankehuanpai = baosantankehuanpai;
    }
}
