...
public class MaanshanMajiangJuPlayerResult implements GameJuPlayerResult {
	...
	public MaanshanMajiangJuPlayerResult(Map juPlayerResult) {
...
//		this.fangPaoCount = ((Double) juPlayerResult.get("fangPaoCount")).intValue();
	...
	public MaanshanMajiangJuPlayerResult() {
