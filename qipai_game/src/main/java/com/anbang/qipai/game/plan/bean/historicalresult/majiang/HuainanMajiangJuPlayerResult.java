...
public class HuainanMajiangJuPlayerResult implements GameJuPlayerResult {
	...
	public HuainanMajiangJuPlayerResult(Map juPlayerResult) {
...
//		this.fangPaoCount = ((Double) juPlayerResult.get("fangPaoCount")).intValue();
	...
	public HuainanMajiangJuPlayerResult() {
