...
public class TaixingMajiangJuPlayerResult implements GameJuPlayerResult {
	...
	public TaixingMajiangJuPlayerResult(Map juPlayerResult) {
	...
	public TaixingMajiangJuPlayerResult() {
