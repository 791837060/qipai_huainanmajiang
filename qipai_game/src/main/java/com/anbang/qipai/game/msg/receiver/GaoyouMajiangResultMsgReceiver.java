...
import com.anbang.qipai.game.msg.channel.sink.GaoyouMajiangResultSink;
...
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.GaoyouMajiangJuPlayerResult;
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.GaoyouMajiangPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (room != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) map.get("playerResultList")).forEach((juPlayerResult) -> juPlayerResultList.add(new GaoyouMajiangJuPlayerResult((Map) juPlayerResult)));
                        ...
                        memberLatAndLonService.gaoyouMajiangDels(juPlayerResultList);
            ...
            if (gid != null) {
                ...
                if (room != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new GaoyouMajiangPanPlayerResult((Map) panPlayerResult)));
