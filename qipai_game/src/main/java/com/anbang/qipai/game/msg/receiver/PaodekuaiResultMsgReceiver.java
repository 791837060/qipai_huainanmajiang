			...
			if (gid != null && dyjId != null && dthId != null) {
				...
				if (room != null) {
					...
					if (playerList != null) {
						...
						((List) playerList).forEach((juPlayerResult) -> juPlayerResultList.add(new PaodekuaiJuPlayerResult((Map) juPlayerResult)));
						...
						memberLatAndLonService.paodekuaiDels(juPlayerResultList);
			...
			if (gid != null) {
				...
				if (room != null) {
					...
					if (playerList != null) {
						...
						((List) map.get("playerResultList")).forEach((panPlayerResult) -> panPlayerResultList.add(new PaodekuaiPanPlayerResult((Map) panPlayerResult)));
