...
import com.anbang.qipai.game.msg.channel.sink.TaixingMajiangGameSink;
...
@EnableBinding(TaixingMajiangGameSink.class)
public class TaixingMajiangGameMsgReveiver {
    ...
    @StreamListener(TaixingMajiangGameSink.TAIXINGMAJIANGGAME)
    public void receive(CommonMO mo) {
        ...
        if ("playerQuit".equals(msg)) {// 有人退出游戏
            ...
            if (room != null) {
                ...
                gameService.playerQuitGame(Game.taixingMajiang,gameId, playerId);
            }
        }
        if ("ju canceled".equals(msg)) {// 取消游戏
            Map data = (Map) mo.getData();
            String gameId = (String) data.get("gameId");
            GameRoom gameRoom = gameService.findRoomByGameAndServerGameGameId(Game.taixingMajiang, gameId);
            if (gameRoom != null) {
                ...
                gameService.gameRoomFinished(Game.taixingMajiang, gameId);
            }
        }
        ...
        if ("pan finished".equals(msg)) {// 一盘游戏结束
            ...
            gameService.panFinished(Game.taixingMajiang, gameId, no, playerIds);
        }
        if ("game delay".equals(msg)) {// 游戏延时
            ...
            if (gameRoom != null) {
                // 延时11小时
                gameService.delayGameRoom(Game.taixingMajiang, gameId, gameRoom.getDeadlineTime() + 11 * 60 * 60 * 1000);
            }
        }
    }
