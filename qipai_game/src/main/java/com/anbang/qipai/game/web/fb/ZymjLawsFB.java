...
public class ZymjLawsFB {
    ...
    public ZymjLawsFB(List<String> lawNames) {
...
//    }
    ...
    public String getKepeng() {
        return kepeng;
    }

    public void setKepeng(String kepeng) {
        this.kepeng = kepeng;
    }
}
