...
import com.anbang.qipai.game.msg.channel.sink.HuainanMajiangResultSink;
...
@EnableBinding(HuainanMajiangResultSink.class)
public class HuainanMajiangResultMsgReceiver {
    @Autowired
    ...
    @StreamListener(HuainanMajiangResultSink.HUAINANMAJIANGRESULT)
    public void recordMajiangHistoricalResult(CommonMO mo) {
        String msg = mo.getMsg();
        String json = gson.toJson(mo.getData());
        Map map = gson.fromJson(json, Map.class);
        if ("huainanMajiang ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (room != null) {
                    ...
                    majiangHistoricalResult.setGame(Game.huainanmajiang);
        ...
        if ("huainanMajiang pan result".equals(msg)) {
            Object gid = map.get("gameId");
            if (gid != null) {
                String gameId = (String) gid;
                GameRoom room = gameService.findRoomByGameAndServerGameGameId(Game.huainanmajiang, gameId);
