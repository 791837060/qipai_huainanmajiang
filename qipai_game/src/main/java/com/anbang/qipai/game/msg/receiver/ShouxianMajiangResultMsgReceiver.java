...
import com.anbang.qipai.game.msg.channel.sink.ShouxianMajiangResultSink;
...
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.ShouxianMajiangJuPlayerResult;
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.ShouxianMajiangPanPlayerResult;
...
@EnableBinding(ShouxianMajiangResultSink.class)
public class ShouxianMajiangResultMsgReceiver {
    @Autowired
    ...
    @StreamListener(ShouxianMajiangResultSink.SHOUXIANMAJIANGRESULT)
    public void recordMajiangHistoricalResult(CommonMO mo) {
        String msg = mo.getMsg();
        String json = gson.toJson(mo.getData());
        Map map = gson.fromJson(json, Map.class);
        if ("shouxianMajiang ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (room != null) {
                    ...
                    majiangHistoricalResult.setGame(Game.shouxianMajiang);
                    ...
                    if (playerList != null) {
                        ...
                        ((List) map.get("playerResultList")).forEach((juPlayerResult) -> juPlayerResultList.add(new ShouxianMajiangJuPlayerResult((Map) juPlayerResult)));
        ...
        if ("shouxianMajiang pan result".equals(msg)) {
            Object gid = map.get("gameId");
            if (gid != null) {
                String gameId = (String) gid;
                GameRoom room = gameService.findRoomByGameAndServerGameGameId(Game.shouxianMajiang, gameId);
                if (room != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new ShouxianMajiangPanPlayerResult((Map) panPlayerResult)));
