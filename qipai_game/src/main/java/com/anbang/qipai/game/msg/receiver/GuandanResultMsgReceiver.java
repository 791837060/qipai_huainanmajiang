...
import com.anbang.qipai.game.msg.channel.sink.GuandanResultSink;
...
import com.anbang.qipai.game.plan.bean.historicalresult.puke.GuandanPanPlayerResult;
			...
			if (gid != null && dyjId != null && dthId != null) {
				...
				if (room != null) {
					...
					if (playerList != null) {
						...
						memberLatAndLonService.guandanDels(juPlayerResultList);
