...
public class BhLawsFB {
    ...
    public BhLawsFB(List<String> lawNames) {
        lawNames.forEach((lawName) -> {
            if (lawName.equals("sanj")) {// 三局
                ...
                youzixianshi = "true";
            } else if (lawName.equals("swyqh")) {// 十五油起胡
                shiwuyouqihu = "true";
    ...
    public String getShiwuyouqihu() {
        return shiwuyouqihu;
    }

    public void setShiwuyouqihu(String shiwuyouqihu) {
        this.shiwuyouqihu = shiwuyouqihu;
    }
