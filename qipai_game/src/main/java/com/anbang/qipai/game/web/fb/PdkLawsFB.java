...
public class PdkLawsFB {
    ...
    private String aBoom = "false";              //三个A当做炸弹
    ...
    private String sidaier = "false";            //四带二
    private String sidaisan = "false";           //四带三
    ...
    public PdkLawsFB(List<String> lawNames) {
        lawNames.forEach((lawName) -> {
            if (lawName.equals("lj")) {                     //6局
                ...
                renshu = "3";
            } else if (lawName.equals("bichu")) {           //有必出牌必须出
                bichu = "true";
            } else if (lawName.equals("biya")) {            //必压必须压
                biya = "true";
            } else if (lawName.equals("aBoom")) {           //3A炸弹
                aBoom = "true";
            } else if (lawName.equals("sandaique")) {       //三带可缺牌
                sandaique = "true";
            } else if (lawName.equals("feijique")) {        //飞机可缺牌
                feijique = "true";
            } else if (lawName.equals("showShoupaiNum")) {  //显示牌数
                showShoupaiNum = "true";
            } else if (lawName.equals("zhuaniao")) {        //扎鸟
                zhuaniao = "true";
            } else if (lawName.equals("sidaier")) {         //四带二
                sidaier = "true";
            } else if (lawName.equals("sidaisan")) {        //四带三
                sidaisan = "true";
            } else if (lawName.equals("gps")) {             //GPS
                gps = "true";
            } else if (lawName.equals("shiwuzhang")) {      //十五张牌
                shiwuzhang = "true";
            } else if (lawName.equals("shiliuzhang")) {     //十六张牌
                shiliuzhang = "true";
                ...
                fanguan = "true";
            } else if (lawName.equals("sdld")) {            //三带两单
                sandailiangdan = "true";
