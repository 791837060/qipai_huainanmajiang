...
import com.anbang.qipai.game.msg.channel.sink.HongzhongMajiangResultSink;
...
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.HongzhongMajiangJuPlayerResult;
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.HongzhongMajiangPanPlayerResult;
...
@EnableBinding(HongzhongMajiangResultSink.class)
public class HongzhongMajiangResultMsgReceiver {
    @Autowired
    ...
    @StreamListener(HongzhongMajiangResultSink.HONGZHONGMAJIANGRESULT)
    public void recordMajiangHistoricalResult(CommonMO mo) {
        String msg = mo.getMsg();
        String json = gson.toJson(mo.getData());
        Map map = gson.fromJson(json, Map.class);
        if ("hongzhongMajiang ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                GameRoom room = gameService.findRoomByGameAndServerGameGameId(Game.hongzhongMajiang, gameId);
                if (room != null) {
                    ...
                    majiangHistoricalResult.setGame(Game.hongzhongMajiang);
                    ...
                    if (playerList != null) {
                        ...
                        ((List) map.get("playerResultList")).forEach((juPlayerResult) -> juPlayerResultList.add(new HongzhongMajiangJuPlayerResult((Map) juPlayerResult)));
                        ...
                        memberLatAndLonService.hongzhongMajiangDels(juPlayerResultList);
                        majiangHistoricalResultService.addGameHistoricalResult(majiangHistoricalResult);
                    }
                }
            }
        }
        if ("hongzhongMajiang pan result".equals(msg)) {
            Object gid = map.get("gameId");
            if (gid != null) {
                String gameId = (String) gid;
                GameRoom room = gameService.findRoomByGameAndServerGameGameId(Game.hongzhongMajiang, gameId);
                if (room != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new HongzhongMajiangPanPlayerResult((Map) panPlayerResult)));
