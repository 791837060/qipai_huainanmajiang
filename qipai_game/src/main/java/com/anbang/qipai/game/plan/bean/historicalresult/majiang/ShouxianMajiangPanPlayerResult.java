...
public class ShouxianMajiangPanPlayerResult implements GamePanPlayerResult {
    private String playerId;// 玩家id
    private String nickname;// 玩家昵称
    private double score;// 一盘总分

    public ShouxianMajiangPanPlayerResult() {

    }

    public ShouxianMajiangPanPlayerResult(Map panPlayerResult) {
