...
public class HongzhongMajiangJuPlayerResult implements GameJuPlayerResult {
	...
	public HongzhongMajiangJuPlayerResult(Map juPlayerResult) {
...
//		this.fangPaoCount = ((Double) juPlayerResult.get("fangPaoCount")).intValue();
	...
	public HongzhongMajiangJuPlayerResult() {
