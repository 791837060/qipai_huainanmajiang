...
import com.anbang.qipai.game.msg.channel.sink.YizhengMajiangResultSink;
...
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.YizhengMajiangJuPlayerResult;
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.YizhengMajiangPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (room != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) map.get("playerResultList")).forEach((juPlayerResult) -> juPlayerResultList.add(new YizhengMajiangJuPlayerResult((Map) juPlayerResult)));
                        ...
                        memberLatAndLonService.yizhengMajiangDels(juPlayerResultList);
            ...
            if (gid != null) {
                ...
                if (room != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new YizhengMajiangPanPlayerResult((Map) panPlayerResult)));
