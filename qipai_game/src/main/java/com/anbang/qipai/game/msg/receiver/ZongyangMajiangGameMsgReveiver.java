...
import com.anbang.qipai.game.msg.channel.sink.ZongyangMajiangGameSink;
...
@EnableBinding(ZongyangMajiangGameSink.class)
public class ZongyangMajiangGameMsgReveiver {
    ...
    @StreamListener(ZongyangMajiangGameSink.ZONGYANGMAJIANGGAME)
    public void receive(CommonMO mo) {
        ...
        if ("playerQuit".equals(msg)) {// 有人退出游戏
            ...
            if (room != null) {
                ...
                gameService.playerQuitGame(Game.zongyangMajiang,gameId, playerId);
            }
        }
        if ("ju canceled".equals(msg)) {// 取消游戏
            Map data = (Map) mo.getData();
            String gameId = (String) data.get("gameId");
            GameRoom gameRoom = gameService.findRoomByGameAndServerGameGameId(Game.zongyangMajiang, gameId);
            if (gameRoom != null) {
                ...
                gameService.gameRoomFinished(Game.zongyangMajiang, gameId);
            }
        }
        ...
        if ("pan finished".equals(msg)) {// 一盘游戏结束
            ...
            gameService.panFinished(Game.zongyangMajiang, gameId, no, playerIds);
        }
        if ("game delay".equals(msg)) {// 游戏延时
            ...
            if (gameRoom != null) {
                // 延时11小时
                gameService.delayGameRoom(Game.zongyangMajiang, gameId, gameRoom.getDeadlineTime() + 11 * 60 * 60 * 1000);
            }
        }
    }
