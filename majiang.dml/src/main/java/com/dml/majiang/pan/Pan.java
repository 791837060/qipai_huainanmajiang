...
public class Pan {
    ...
    public Set<MajiangPai> getPublicBanziSet() {
        return publicBanziSet;
    }

    public void setPublicBanziSet(Set<MajiangPai> publicBanziSet) {
        this.publicBanziSet = publicBanziSet;
    }

    public Set<MajiangPai> getPublicDazigenSet() {
        return publicDazigenSet;
    }

    public void setPublicDazigenSet(Set<MajiangPai> publicDazigenSet) {
        this.publicDazigenSet = publicDazigenSet;
    }

    public boolean isDaoNewPan() {
        return daoNewPan;
    }

    public void setDaoNewPan(boolean daoNewPan) {
        this.daoNewPan = daoNewPan;
    }
}
