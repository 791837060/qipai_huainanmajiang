...
import com.anbang.qipai.dalianmeng.msg.sink.MaanshanMajiangResultSink;
...
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.MaanshanMajiangJuPlayerResult;
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.MaanshanMajiangPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.maanshanMajiang);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                MaanshanMajiangJuPlayerResult pr = new MaanshanMajiangJuPlayerResult((Map) juPlayerResult);
