...
import com.anbang.qipai.dalianmeng.plan.bean.game.GameTableStateConfig;
import com.anbang.qipai.dalianmeng.plan.dao.GameTableDao;
import com.anbang.qipai.dalianmeng.plan.dao.mongodb.repository.GameTableRepository;
...
public class MongodbGameTableDao implements GameTableDao {
    ...
    @Override
    public List<GameTable> findGameTableByMemberIdAndLianmengIdAndGameAndTime(int page, int size, String memberId, String lianmengId,Game game,
    ...
    public void deleteGameTableByNo(String roomNo) {
        ...
        Update update = new Update();
        update.set("state", GameTableStateConfig.FINISH);
    ...
    public void removeByTime(long endTime) {
        mongoTemplate.remove(new Query(Criteria.where("deadlineTime").lt(endTime)), GameTable.class);
    }
