...
import com.anbang.qipai.dalianmeng.msg.sink.GuandanResultSink;
...
import com.anbang.qipai.dalianmeng.plan.bean.result.puke.GuandanJuPlayerResult;
import com.anbang.qipai.dalianmeng.plan.bean.result.puke.GuandanPanPlayerResult;
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new GuandanPanPlayerResult((Map) panPlayerResult)));
