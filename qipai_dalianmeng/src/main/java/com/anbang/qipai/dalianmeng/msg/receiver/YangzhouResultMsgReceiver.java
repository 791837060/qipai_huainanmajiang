...
import com.anbang.qipai.dalianmeng.msg.sink.YangzhouMajiangResultSink;
...
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.YangzhouMajiangJuPlayerResult;
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.YangzhouMajiangPanPlayerResult;
...
public class YangzhouResultMsgReceiver {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.yangzhouMajiang);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                YangzhouMajiangJuPlayerResult pr = new YangzhouMajiangJuPlayerResult((Map) juPlayerResult);
            ...
            if (gid != null) {
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new YangzhouMajiangPanPlayerResult((Map) panPlayerResult)));
