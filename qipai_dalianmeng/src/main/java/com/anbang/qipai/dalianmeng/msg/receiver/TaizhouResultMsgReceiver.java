...
import com.anbang.qipai.dalianmeng.msg.sink.TaizhouMajiangResultSink;
...
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.TaizhouMajiangJuPlayerResult;
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.TaizhouMajiangPanPlayerResult;
...
public class TaizhouResultMsgReceiver {
    ...
    public void recordMajiangHistoricalResult(CommonMO mo) {
        ...
        if ("taizhouMajiang ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                GameTable table = playService.findTableByGameAndServerGameGameId(Game.taizhouMajiang, gameId);
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.taizhouMajiang);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                TaizhouMajiangJuPlayerResult pr = new TaizhouMajiangJuPlayerResult((Map) juPlayerResult);
