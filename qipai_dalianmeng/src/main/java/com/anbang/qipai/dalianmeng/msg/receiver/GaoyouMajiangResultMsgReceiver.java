...
import com.anbang.qipai.dalianmeng.msg.sink.GaoyouMajiangResultSink;
...
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.GaoyouMajiangJuPlayerResult;
import com.anbang.qipai.dalianmeng.plan.bean.result.majiang.GaoyouMajiangPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.gaoyouMajiang);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                GaoyouMajiangJuPlayerResult pr = new GaoyouMajiangJuPlayerResult((Map) juPlayerResult);
