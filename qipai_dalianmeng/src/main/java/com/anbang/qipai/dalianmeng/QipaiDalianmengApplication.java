package com.anbang.qipai.dalianmeng;

import com.anbang.qipai.dalianmeng.conf.FilePathConfig;
import com.anbang.qipai.dalianmeng.cqrs.c.repository.SingletonEntityFactoryImpl;
import com.anbang.qipai.dalianmeng.cqrs.c.service.disruptor.CoreSnapshotFactory;
...
import com.anbang.qipai.dalianmeng.init.InitProcessor;
...
@EnableFeignClients
@EnableScheduling
public class QipaiDalianmengApplication {
    @Autowired
    ...
    public InitProcessor initProcessor() {
        InitProcessor initProcessor = new InitProcessor(httpClient(), sslHttpClient(), snapshotJsonUtil, processCoreCommandEventHandler(), singletonEntityRepository(), applicationContext);
        initProcessor.init();
        return initProcessor;
    }

    public static void main(String[] args) {
        SpringApplication.run(QipaiDalianmengApplication.class, args);
    }
