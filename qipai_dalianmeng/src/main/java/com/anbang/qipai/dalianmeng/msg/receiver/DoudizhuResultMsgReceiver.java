...
import com.anbang.qipai.dalianmeng.msg.sink.DoudizhuResultSink;
...
import com.anbang.qipai.dalianmeng.plan.bean.result.puke.DoudizhuJuPlayerResult;
import com.anbang.qipai.dalianmeng.plan.bean.result.puke.DoudizhuPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.doudizhu);
            ...
            if (gid != null) {
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new DoudizhuPanPlayerResult((Map) panPlayerResult)));
