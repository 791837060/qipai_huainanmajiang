        ...
        if ("doudizhu ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (playerList != null) {
                    ...
                    ((List) playerList).forEach((juPlayerResult) -> juPlayerResultList.add(new DoudizhuJuPlayerResult((Map) juPlayerResult)));
        ...
        if ("doudizhu pan result".equals(msg)) {
            ...
            if (gid != null) {
                ...
                if (playerList != null) {
                    ...
                    ((List) map.get("playerResultList")).forEach((panPlayerResult) -> panPlayerResultList.add(new DoudizhuPanPlayerResult((Map) panPlayerResult)));
