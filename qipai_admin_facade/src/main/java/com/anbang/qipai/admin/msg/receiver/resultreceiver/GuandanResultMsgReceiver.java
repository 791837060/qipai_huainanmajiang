...
import com.anbang.qipai.admin.msg.channel.sink.resultsink.GuandanResultSink;
...
import com.anbang.qipai.admin.plan.bean.historicalresult.majiang.GuandanJuPlayerResult;
import com.anbang.qipai.admin.plan.bean.historicalresult.majiang.GuandanPanPlayerResult;
...
@EnableBinding(GuandanResultSink.class)
public class GuandanResultMsgReceiver {
    @Autowired
    ...
    @StreamListener(GuandanResultSink.GUANDANRESULT)
    public void recordMajiangHistoricalResult(CommonMO mo) {
        String msg = mo.getMsg();
        String json = gson.toJson(mo.getData());
        // 游戏局盘记录存储
        Map map = gson.fromJson(json, Map.class);
        if ("guandan ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                GameRoom room = gameService.findRoomByGameAndServerGameGameId(Game.guandan, gameId);
                ...
                majiangHistoricalResult.setGame(Game.guandan);
                ...
                if (playerList != null) {
                    ...
                    ((List) playerList).forEach((juPlayerResult) -> juPlayerResultList.add(new GuandanJuPlayerResult((Map) juPlayerResult)));
        ...
        if ("guandan pan result".equals(msg)) {
            Object gid = map.get("gameId");
            if (gid != null) {
                String gameId = (String) gid;
                ...
                if (playerList != null) {
                    ...
                    ((List) map.get("playerResultList")).forEach((panPlayerResult) -> panPlayerResultList.add(new GuandanPanPlayerResult((Map) panPlayerResult)));
