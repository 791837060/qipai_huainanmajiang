...
import com.anbang.qipai.admin.remote.service.DalianmengRemoteService;
...
@CrossOrigin
@RestController
@RequestMapping("/dalianmeng")
public class DalianmemngController {

    @Autowired
    private DalianmengRemoteService dalianmengRemoteService;
    ...
    public CommonVO GiveToMember(String token, String memberId, Integer amount){
        ...
        CommonRemoteVO commonRemoteVO = dalianmengRemoteService.giveYushiToMember(memberId, amount);
     ...
     */
    @RequestMapping("/updateAdminDiamondLimit")
    public CommonVO updateAdminDiamondLimint(String token, Integer diamondLimit, String adminId, String nickName){
        CommonVO vo=new CommonVO();
        long accountingTime=System.currentTimeMillis();//充值时间
        AdminDiamondLimitRecord adminDiamondLimitRecord = new AdminDiamondLimitRecord();
        ...
        if (!adminRole){
            if (!adminId.equals(adminById.getId())){
                ...
                if (adminById1.getDiamondLimit()<diamondLimit) {
                    vo.setSuccess(false);
                    vo.setMsg("限额不足");
                    return vo;
                }
                adminService.updateAdminDiamondLimint(adminIdBySession,diamondLimit,adminById1.getDiamondLimit());
            }else {
                Admin adminById1 = adminService.findAdminById(adminIdBySession);
                if (adminById1.getDiamondLimit()<diamondLimit) {
                    vo.setSuccess(false);
                ...
                adminService.updateAdminDiamondLimint(adminId,0,diamondLimit);
                //查询赠送砖石管理员的剩余额度
                Admin admin = adminService.queryAdminDiamondBalance(adminId);
                int balance = admin.getDiamondLimit();//获取管理员剩余砖石额度。
                adminDiamondLimitRecord.setAccountingTime(accountingTime);
                adminDiamondLimitRecord.setBalance(balance);
                adminDiamondLimitRecord.setDiamondAmount(diamondLimit);
    ...
    public CommonVO querylianmeng(@RequestParam(value = "page",defaultValue = "1") int page,
        ...
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO = dalianmengRemoteService.queryLianmeng(page,size,lianmengId,memberId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
    ...
    public CommonVO querylianmeng_hehuoren(@RequestParam(value = "page",defaultValue = "1") int page,
                                           ...
                                           String lianmengId){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO = dalianmengRemoteService.querylianmeng_hehuoren(page,size,lianmengId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO querylianmeng_member(@RequestParam(value = "page",defaultValue = "1") int page,
                                         ...
                                         String lianmengId){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO = dalianmengRemoteService.querylianmeng_member(page,size,lianmengId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO query_hehuoren_member(@RequestParam(value = "lianmengId")String lianmengId){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.query_hehuoren_member(lianmengId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO lianmeng_mengzhu(@RequestParam(value = "memberId")String memberId){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.lianmeng_mengzhu(memberId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO querylianmengBymengzhu(@RequestParam(value = "page",defaultValue = "1") int page,
                                           ...
                                           String mengzhuId){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.querylianmengBymengzhu(page,size,mengzhuId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO lianmeng_cost(String goldSort, String gameSort, String mengzhu, String lianmengId, Long startTime, Long endTime){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.lianmeng_cost(goldSort,gameSort,mengzhu,lianmengId,startTime,endTime);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO gametable_query(@RequestParam(value = "page",defaultValue = "1") int page,
                                    @RequestParam(value = "size",defaultValue = "30") int size,
                                    String memberId, String lianmengId, String game, Long startTime, Long endTime,String no,String state){
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.gametable_query(page,size,memberId,lianmengId,game,startTime,endTime,no,state);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO gamereport(@RequestParam(value = "startTime",required = true) Long startTime,
        ...
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.gamereport(startTime,endTime,game);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO queryMemberPowerDetail(@RequestParam(value = "page",defaultValue = "1") int page,
        ...
        CommonVO vo = new CommonVO();
        CommonRemoteVO commonRemoteVO=dalianmengRemoteService.queryMemberPowerDetail(page,size,memberId,lianmengId,queryTime);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
    ...
    public CommonVO queryroomdetail(String gameId){
        CommonVO vo=new CommonVO();
        CommonRemoteVO commonRemoteVO = dalianmengRemoteService.queryroomdetail(gameId);
        if (commonRemoteVO.isSuccess()){
            vo.setMsg(commonRemoteVO.getMsg());
            vo.setData(commonRemoteVO.getData());
            return vo;
