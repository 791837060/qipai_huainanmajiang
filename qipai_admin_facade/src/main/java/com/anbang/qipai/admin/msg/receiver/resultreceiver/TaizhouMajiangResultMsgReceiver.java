...
import com.anbang.qipai.admin.msg.channel.sink.resultsink.TaizhouMajiangResultSink;
...
import com.anbang.qipai.admin.plan.bean.historicalresult.majiang.TaizhouMajiangJuPlayerResult;
import com.anbang.qipai.admin.plan.bean.historicalresult.majiang.TaizhouMajiangPanPlayerResult;
        ...
        if ("taizhouMajiang ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (playerList != null) {
                    ...
                    ((List) playerList).forEach((juPlayerResult) -> juPlayerResultList.add(new TaizhouMajiangJuPlayerResult((Map) juPlayerResult)));
        ...
        if ("taizhouMajiang pan result".equals(msg)) {
            ...
            if (gid != null) {
                ...
                if (playerList != null) {
                    ...
                    ((List) map.get("playerResultList")).forEach((panPlayerResult) -> panPlayerResultList.add(new TaizhouMajiangPanPlayerResult((Map) panPlayerResult)));
