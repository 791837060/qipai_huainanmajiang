...
import com.anbang.qipai.admin.msg.channel.sink.resultsink.YangzhouMajiangResultSink;
...
import com.anbang.qipai.admin.plan.bean.historicalresult.majiang.YangzhouMajiangJuPlayerResult;
import com.anbang.qipai.admin.plan.bean.historicalresult.majiang.YangzhouMajiangPanPlayerResult;
...
@EnableBinding(YangzhouMajiangResultSink.class)
public class YangzhouMajiangResultMsgReceiver {
    @Autowired
    ...
    @StreamListener(YangzhouMajiangResultSink.YANGZHOUMAJIANGRESULT)
    public void recordMajiangHistoricalResult(CommonMO mo) {
        String msg = mo.getMsg();
        String json = gson.toJson(mo.getData());
        // 游戏局盘记录存储
        Map map = gson.fromJson(json, Map.class);
        if ("yangzhouMajiang ju result".equals(msg)) {
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                majiangHistoricalResult.setGame(Game.yangzhouMajiang);
                ...
                if (playerList != null) {
                    ...
                    ((List) playerList).forEach((juPlayerResult) -> juPlayerResultList.add(new YangzhouMajiangJuPlayerResult((Map) juPlayerResult)));
        ...
        if ("yangzhouMajiang pan result".equals(msg)) {
            Object gid = map.get("gameId");
            if (gid != null) {
                String gameId = (String) gid;
                ...
                if (playerList != null) {
                    ...
                    ((List) map.get("playerResultList")).forEach((panPlayerResult) -> panPlayerResultList.add(new YangzhouMajiangPanPlayerResult((Map) panPlayerResult)));
