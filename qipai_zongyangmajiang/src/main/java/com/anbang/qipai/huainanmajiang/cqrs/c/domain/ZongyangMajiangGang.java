...
public class ZongyangMajiangGang {
    private int zimoMingGangShu;        //自摸杠
    private int fangGangmingGangShu;
    private int anGangShu;              //暗杠
    private int value;

    public ZongyangMajiangGang() {

    }

    public ZongyangMajiangGang(MajiangPlayer player) {
    ...
    public void calculate(int playerCount, int fangGangCount) {
        value = (anGangShu + zimoMingGangShu + fangGangmingGangShu) * (playerCount - 1) - fangGangCount;
    }
