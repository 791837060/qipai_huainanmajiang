...
import com.anbang.qipai.huainanmajiang.msg.channel.HongzhongMajiangGameSource;
import com.anbang.qipai.huainanmajiang.msg.msjobj.CommonMO;
import com.dml.majiang.pan.frame.PanValueObject;

@EnableBinding(HongzhongMajiangGameSource.class)
public class TuiDaoHuGameMsgService {

	@Autowired
	private HongzhongMajiangGameSource hongzhongMajiangGameGameSource;
	...
	public void gamePlayerLeave(MajiangGameValueObject majiangGameValueObject, String playerId) {
		...
		if (playerIsQuit) {
			...
			mo.setData(data);
			hongzhongMajiangGameGameSource.hongzhongMajiangGame().send(MessageBuilder.withPayload(mo).build());
		}
	}
