...
public class TimeoverQuitGameLeaveStrategy implements GameLeaveStrategy {
    ...
    private MajiangGameQueryService gameQueryService;
    ...
    public TimeoverQuitGameLeaveStrategy(long overtime, MajiangGameQueryService gameQueryService, TuiDaoHuGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
            ...
            new Thread(() -> {
                try {
                    ...
                    if (leaveTime != null && System.currentTimeMillis() - leaveTime >= overtime) {
                        ...
                        gameQueryService.leaveGame(majiangGameValueObject);
