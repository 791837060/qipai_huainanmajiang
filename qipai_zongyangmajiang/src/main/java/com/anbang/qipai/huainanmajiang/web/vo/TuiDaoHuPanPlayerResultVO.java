...
import com.anbang.qipai.huainanmajiang.cqrs.c.domain.ZongyangMajiangGang;
import com.anbang.qipai.huainanmajiang.cqrs.c.domain.ZongyangMajiangHushu;
...
public class TuiDaoHuPanPlayerResultVO {
    ...
    public TuiDaoHuPanPlayerResultVO(MajiangGamePlayerDbo gamePlayerDbo, String zhuangPlayerId, boolean zimo, String dianpaoPlayerId, TuiDaoHuPanPlayerResultDbo panPlayerResult) {
        ...
        ZongyangMajiangNiao tuidaohuNiao = panPlayerResult.getPlayerResult().getNiao();
