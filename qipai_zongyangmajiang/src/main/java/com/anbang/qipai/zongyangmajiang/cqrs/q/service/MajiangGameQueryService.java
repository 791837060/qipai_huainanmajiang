package com.anbang.qipai.zongyangmajiang.cqrs.q.service;
...
import com.anbang.qipai.zongyangmajiang.cqrs.q.dao.*;
...
import com.anbang.qipai.zongyangmajiang.plan.dao.PlayerInfoDao;
...
public class MajiangGameQueryService {
    ...
    public void leaveGame(MajiangGameValueObject majiangGame) {
        ...
        if (majiangGame.getJuResult() != null) {
            ZongyangMajiangJuResult tuidaohuJuResult = (ZongyangMajiangJuResult) majiangGame.getJuResult();
            JuResultDbo juResultDbo = new JuResultDbo(majiangGame.getId(), null, tuidaohuJuResult);
    ...
    public void finishGameImmediately(MajiangGameValueObject majiangGameValueObject) {
        ...
        if (majiangGameValueObject.getJuResult() != null) {
            ZongyangMajiangJuResult tuidaohuJuResult = (ZongyangMajiangJuResult) majiangGameValueObject.getJuResult();
            JuResultDbo juResultDbo = new JuResultDbo(majiangGameValueObject.getId(), null, tuidaohuJuResult);
            juResultDboDao.save(juResultDbo);
        }
    }
    ...
    public void finishGameImmediately(MajiangGameValueObject majiangGameValueObject, PanResultDbo panResultDbo) {
        ...
        majiangGameDboDao.save(majiangGameDbo);
        if (majiangGameValueObject.getJuResult() != null) {
            ZongyangMajiangJuResult yingjiuzhangJuResult = (ZongyangMajiangJuResult) majiangGameValueObject.getJuResult();
            JuResultDbo juResultDbo = new JuResultDbo(majiangGameValueObject.getId(), panResultDbo, yingjiuzhangJuResult);
            juResultDboDao.save(juResultDbo);
        }
    }
