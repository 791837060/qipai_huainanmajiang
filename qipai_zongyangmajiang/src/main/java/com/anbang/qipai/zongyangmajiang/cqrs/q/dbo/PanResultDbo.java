...
import com.anbang.qipai.zongyangmajiang.cqrs.c.domain.ZongyangMajiangPanPlayerResult;
import com.anbang.qipai.zongyangmajiang.cqrs.c.domain.ZongyangMajiangPanResult;
...
public class PanResultDbo {
    ...
    public PanResultDbo(String gameId, ZongyangMajiangPanResult tuidaohuPanResult) {
        this.gameId = gameId;
        ...
        for (ZongyangMajiangPanPlayerResult playerResult : tuidaohuPanResult.getPanPlayerResultList()) {
