...
public class ZongyangMajiangRemoveZhongOrFengFaRandomAvaliablePaiFiller implements AvaliablePaiFiller {

    private long seed;
    OptionalPlay optionalPlay;

    public ZongyangMajiangRemoveZhongOrFengFaRandomAvaliablePaiFiller() {
    }

    public ZongyangMajiangRemoveZhongOrFengFaRandomAvaliablePaiFiller(long seed, OptionalPlay optionalPlay) {
        this.seed = seed;
