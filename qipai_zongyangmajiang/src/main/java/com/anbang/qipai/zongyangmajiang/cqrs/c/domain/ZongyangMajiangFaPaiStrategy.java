 ...
 * 顺序发牌
 */
public class ZongyangMajiangFaPaiStrategy implements FaPaiStrategy {
    /**
     * 每个玩家发牌数量
     */
    private int faPaiCountsForOnePlayer;

    public ZongyangMajiangFaPaiStrategy() {
    }

    public ZongyangMajiangFaPaiStrategy(int faPaiCountsForOnePlayer) {
