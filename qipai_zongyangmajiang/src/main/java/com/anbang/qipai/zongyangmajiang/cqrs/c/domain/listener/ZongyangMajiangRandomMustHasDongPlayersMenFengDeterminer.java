...
public class ZongyangMajiangRandomMustHasDongPlayersMenFengDeterminer{
	...
	public void determinePlayersMenFeng(Ju ju, MajiangGame majiangGame) throws Exception {
		...
		for (String s : sortedPlayerIdList) {
			if (s.equals(majiangGame.getCreateplayId())){
