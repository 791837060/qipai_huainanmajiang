 ...
 * @author lsc
 */
public class ZongyangMajiangPengActionUpdater implements MajiangPlayerPengActionUpdater {
    ...
    public void updateActions(MajiangPengAction pengAction, Ju ju) throws Exception {
        ...
        ZongyangMajiangPengGangActionStatisticsListener pengGangRecordListener = ju.getActionStatisticsListenerManager().findListener(ZongyangMajiangPengGangActionStatisticsListener.class);//碰杠监测器
