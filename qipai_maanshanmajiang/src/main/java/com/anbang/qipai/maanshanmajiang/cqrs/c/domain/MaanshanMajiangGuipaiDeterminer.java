...
public class MaanshanMajiangGuipaiDeterminer implements GuipaiDeterminer {

    private long seed;
    private boolean hongzhonglaizi;

    public MaanshanMajiangGuipaiDeterminer() {
    }

    public MaanshanMajiangGuipaiDeterminer(long seed, boolean hongzhonglaizi) {
        this.seed = seed;
        this.hongzhonglaizi = hongzhonglaizi;
    }

    public MaanshanMajiangGuipaiDeterminer(long seed) {
        this.seed = seed;
    }
