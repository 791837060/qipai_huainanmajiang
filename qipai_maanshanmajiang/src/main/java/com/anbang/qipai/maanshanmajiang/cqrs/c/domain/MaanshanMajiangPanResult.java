...
public class MaanshanMajiangPanResult extends PanResult {
	/**
	 * 是否胡牌
	 */
	private boolean hu;
	 ...
	 * 玩家盘结果
	 */
	private List<MaanshanMajiangPanPlayerResult> panPlayerResultList;
	...
	public List<MaanshanMajiangPanPlayerResult> getPanPlayerResultList() {
		return panPlayerResultList;
	}

	public void setPanPlayerResultList(List<MaanshanMajiangPanPlayerResult> panPlayerResultList) {
