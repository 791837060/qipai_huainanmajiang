package com.anbang.qipai.maanshanmajiang.cqrs.c.domain.listener;
 ...
 * 碰杠统计检测器
 */
public class MaanshanMajiangPengGangActionStatisticsListener implements MajiangPlayerPengActionStatisticsListener, MajiangPlayerGangActionStatisticsListener {
    ...
    public void update(MajiangGangAction gangAction, Ju ju) {
        ...
        if (gangAction.isDisabledByHigherPriorityAction()) { //如果被阻塞
            ...
            if (gangAction.getGangType().equals(GangType.gangdachu) || gangAction.getGangType().equals(GangType.sanbanziminggang)) { //杠打出
