 ...
 * @author lsc
 */
public class TuiDaoHuPengActionUpdater implements MajiangPlayerPengActionUpdater {
    ...
    public void updateActions(MajiangPengAction pengAction, Ju ju) throws Exception {
        ...
        TuiDaoHuPengGangActionStatisticsListener pengGangRecordListener = ju.getActionStatisticsListenerManager().findListener(TuiDaoHuPengGangActionStatisticsListener.class);//碰杠监测器
