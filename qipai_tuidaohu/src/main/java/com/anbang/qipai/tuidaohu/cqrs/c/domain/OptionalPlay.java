...
//     * 去风牌
//     */
//    private boolean qufengpai;
//    /**
//     * 只可自摸
//     */
//    private boolean zhikezimo;
//    /**
//     * 红中赖子
//     */
//    private boolean hongzhonglaizi;
    ...
    public OptionalPlay(boolean gps, boolean voice, boolean keyidahu, boolean qidui, boolean qiangganghu, int niaoshu, int tuoguan, boolean tuoguanjiesan, boolean lixianchengfa, int lixianshichang, double lixianchengfaScore, int buzhunbeituichushichang, Boolean zidongzhunbei, Boolean zidongkaishi, Double zidongkaishiTime, boolean banVoice, boolean banJiesan) {
        this.gps = gps;
        this.voice = voice;
    ...
    public boolean isKeyidahu() {
        return keyidahu;
    }

    public void setKeyidahu(boolean keyidahu) {
        this.keyidahu = keyidahu;
    }
