 ...
 *
 */
public class ErliuhunHasSiwangLuanpaiStrategy implements LuanpaiStrategy {
	private BianXingWanFa bx;
	private long seed;

	public ErliuhunHasSiwangLuanpaiStrategy() {

	}

	public ErliuhunHasSiwangLuanpaiStrategy(BianXingWanFa bx, long seed) {
		this.bx = bx;
		this.seed = seed;
	}
