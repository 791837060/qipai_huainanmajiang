...
public class BijiJuPlayerResultMO {
	...
	public BijiJuPlayerResultMO(PukeGamePlayerDbo playerDbo) {
	...
	public BijiJuPlayerResultMO(BijiJuPlayerResult juPlayerResult, PukeGamePlayerDbo playerDbo) {
		playerId = playerDbo.getPlayerId();
		nickname = playerDbo.getNickname();
		headimgurl = playerDbo.getHeadimgurl();
