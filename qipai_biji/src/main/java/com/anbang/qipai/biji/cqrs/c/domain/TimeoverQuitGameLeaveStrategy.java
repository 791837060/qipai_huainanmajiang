...
public class TimeoverQuitGameLeaveStrategy implements GameLeaveStrategy {
    ...
    public TimeoverQuitGameLeaveStrategy(long overtime, PukeGameQueryService gameQueryService, BijiGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
