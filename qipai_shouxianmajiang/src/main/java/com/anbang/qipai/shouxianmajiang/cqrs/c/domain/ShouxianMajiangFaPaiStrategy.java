 ...
 * 顺序发牌
 */
public class ShouxianMajiangFaPaiStrategy implements FaPaiStrategy {
    /**
     * 每个玩家发牌数量
     */
    private int faPaiCountsForOnePlayer;

    public ShouxianMajiangFaPaiStrategy() {
    }

    public ShouxianMajiangFaPaiStrategy(int faPaiCountsForOnePlayer) {
