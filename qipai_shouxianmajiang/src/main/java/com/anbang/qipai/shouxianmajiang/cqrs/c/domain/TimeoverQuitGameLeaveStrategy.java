...
public class TimeoverQuitGameLeaveStrategy implements GameLeaveStrategy {
    ...
    public TimeoverQuitGameLeaveStrategy(long overtime, MajiangGameQueryService gameQueryService, ShouxianMajiangGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
