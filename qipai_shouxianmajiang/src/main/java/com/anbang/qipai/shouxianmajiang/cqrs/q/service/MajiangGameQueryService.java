...
public class MajiangGameQueryService {
    ...
    public void leaveGame(MajiangGameValueObject majiangGame) {
        ...
        if (majiangGame.getJuResult() != null) {
            ShouxianMajiangJuResult shouxianmajiangJuResult = (ShouxianMajiangJuResult) majiangGame.getJuResult();
            JuResultDbo juResultDbo = new JuResultDbo(majiangGame.getId(), null, shouxianmajiangJuResult);
    ...
    public void finishGameImmediately(MajiangGameValueObject majiangGameValueObject) {
        ...
        if (majiangGameValueObject.getJuResult() != null) {
            ShouxianMajiangJuResult shouxianmajiangJuResult = (ShouxianMajiangJuResult) majiangGameValueObject.getJuResult();
            JuResultDbo juResultDbo = new JuResultDbo(majiangGameValueObject.getId(), null, shouxianmajiangJuResult);
            juResultDboDao.save(juResultDbo);
        }
    }
    ...
    public void finishGameImmediately(MajiangGameValueObject majiangGameValueObject, PanResultDbo panResultDbo) {
        ...
        majiangGameDboDao.save(majiangGameDbo);
        if (majiangGameValueObject.getJuResult() != null) {
            ShouxianMajiangJuResult yingjiuzhangJuResult = (ShouxianMajiangJuResult) majiangGameValueObject.getJuResult();
