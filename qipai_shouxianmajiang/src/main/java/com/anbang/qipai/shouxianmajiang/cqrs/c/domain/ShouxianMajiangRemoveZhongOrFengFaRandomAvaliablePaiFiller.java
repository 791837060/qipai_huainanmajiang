...
public class ShouxianMajiangRemoveZhongOrFengFaRandomAvaliablePaiFiller implements AvaliablePaiFiller {

    private long seed;
    OptionalPlay optionalPlay;

    public ShouxianMajiangRemoveZhongOrFengFaRandomAvaliablePaiFiller() {
    }

    public ShouxianMajiangRemoveZhongOrFengFaRandomAvaliablePaiFiller(long seed, OptionalPlay optionalPlay) {
        this.seed = seed;
