...
public class ShouxianMajiangJiesuanCalculator {
     ...
     * @return
     */
    public static ShouxianMajiangHu calculateBestZimoHu(boolean couldTianhu, GouXingPanHu gouXingPanHu, MajiangPlayer player, MajiangMoAction moAction, OptionalPlay optionalPlay) {
...
//            ShoupaixingWuguanJiesuancanshu shoupaixingWuguanJiesuancanshu = new ShoupaixingWuguanJiesuancanshu(player, null);
            ShouxianMajiangHushu bestHuFen = null;
            ...
            for (ShoupaiPaiXing shoupaiPaiXing : huPaiShoupaiPaiXingList) {
                ...
                //计算胡分
                ShouxianMajiangHushu hufen = calculateHufen(true, true, moAction.getReason().getName().equals(GanghouBupai.name), shoupaiPaiXing);
            ...
            return new ShouxianMajiangHu(bestHuShoupaiPaiXing, bestHuFen);
        } else { //不成胡
            return null;
        }
    }
...
//     * @return
//     */
//    public static ShouxianMajiangHu calculateBestQianggangHu(MajiangPai gangPai, GouXingPanHu gouXingPanHu, MajiangPlayer player, OptionalPlay optionalPlay) {
...
//                    continue;
//                }
//                ShouxianMajiangHushu hufen = calculateHufen(true,  false, true, false, false, shoupaixingWuguanJiesuancanshu, shoupaiPaiXing, optionalPlay);
//                if (bestHuFen == null || bestHuFen.getValue() < hufen.getValue()) {
//                    bestHuFen = hufen;
//                    bestHuShoupaiPaiXing = shoupaiPaiXing;
//                }
...
//    }
     ...
     * @return
     */
    public static ShouxianMajiangHu calculateBestDianpaoHu(boolean couldDihu, GouXingPanHu gouXingPanHu, MajiangPlayer player, MajiangPai hupai, OptionalPlay optionalPlay) {
        ShoupaiCalculator shoupaiCalculator = player.getShoupaiCalculator();
        List<MajiangPai> guipaiList = player.findGuipaiList();// TODO 也可以用统计器做
...
//            ShoupaixingWuguanJiesuancanshu shoupaixingWuguanJiesuancanshu = new ShoupaixingWuguanJiesuancanshu(player, hupai);
            ...
            for (ShoupaiPaiXing shoupaiPaiXing : huPaiShoupaiPaiXingList) {
                ...
                ShouxianMajiangHushu hufen = calculateHufen(true, false, false, shoupaiPaiXing);
                if (bestHuFen == null || bestHuFen.getValue() < hufen.getValue()) {
                    bestHuFen = hufen;
                    bestHuShoupaiPaiXing = shoupaiPaiXing;
                }
     ...
     * @return
     */
    public static ShouxianMajiangHushu calculateBestHuFenForBuhuPlayer(MajiangPlayer player, OptionalPlay optionalPlay) {
        ShoupaiCalculator shoupaiCalculator = player.getShoupaiCalculator();
        List<MajiangPai> guipaiList = player.findGuipaiList();// TODO 也可以用统计器做
...
//        ShoupaixingWuguanJiesuancanshu shoupaixingWuguanJiesuancanshu = new ShoupaixingWuguanJiesuancanshu(player, null);
        ...
        for (ShoupaiPaiXing shoupaiPaiXing : shoupaiPaiXingList) {
            ShouxianMajiangHushu hufen = calculateHufen(false, false, false, shoupaiPaiXing);
            if (bestHuFen == null || bestHuFen.getValue() < hufen.getValue()) {
                bestHuFen = hufen;
            }
        }
     ...
     * @return
     */
    private static ShouxianMajiangHushu calculateHufen(boolean hu, boolean zimoHu, boolean gangkaiHu, ShoupaiPaiXing shoupaiPaiXing) {
        ...
        if (hu) {
            ...
            if (shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.hongzhong)) {
                hufen.setHongzhong(true);
            }
            if (shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.yiwan) ||
                    shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.yitiao) ||
                    shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.yitong)) {
                hufen.setDuyi(true);
            }
            if (shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.jiuwan) ||
                    shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.jiutiao) ||
                    shoupaiPaiXing.getDuiziList().get(0).getDuiziType().equals(MajiangPai.jiutong)) {
                hufen.setYaojiu(true);
            }
