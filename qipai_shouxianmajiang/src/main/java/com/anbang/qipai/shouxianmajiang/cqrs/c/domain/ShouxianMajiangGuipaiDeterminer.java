...
public class ShouxianMajiangGuipaiDeterminer implements GuipaiDeterminer {

    private long seed;
    private boolean hongzhonglaizi;

    public ShouxianMajiangGuipaiDeterminer() {
    }

    public ShouxianMajiangGuipaiDeterminer(long seed, boolean hongzhonglaizi) {
        this.seed = seed;
        this.hongzhonglaizi = hongzhonglaizi;
    }

    public ShouxianMajiangGuipaiDeterminer(long seed) {
        this.seed = seed;
    }
