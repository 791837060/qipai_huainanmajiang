...
public class OptionalPlay {
    ...
    public OptionalPlay(boolean jiaopao, boolean gps, boolean voice, int tuoguan, boolean tuoguanjiesan, boolean lixianchengfa, int lixianshichang, double lixianchengfaScore, int buzhunbeituichushichang, Boolean zidongzhunbei, Boolean zidongkaishi, Double zidongkaishiTime, boolean banVoice, boolean banJiesan) {
        this.jiaopao = jiaopao;
        this.gps = gps;
        this.voice = voice;
    ...
    public boolean isJiaopao() {
        return jiaopao;
    }

    public void setJiaopao(boolean jiaopao) {
        this.jiaopao = jiaopao;
    }
