 ...
 * @author lsc
 */
public class ShouxianMajiangPengActionUpdater implements MajiangPlayerPengActionUpdater {
    ...
    public void updateActions(MajiangPengAction pengAction, Ju ju) throws Exception {
        ...
        ShouxianMajiangPengGangActionStatisticsListener pengGangRecordListener = ju.getActionStatisticsListenerManager().findListener(ShouxianMajiangPengGangActionStatisticsListener.class);//碰杠监测器
