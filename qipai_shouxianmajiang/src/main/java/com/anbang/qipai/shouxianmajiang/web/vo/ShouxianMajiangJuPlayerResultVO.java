...
public class ShouxianMajiangJuPlayerResultVO {
    ...
    public ShouxianMajiangJuPlayerResultVO(ShouxianMajiangJuPlayerResult juPlayerResult, MajiangGamePlayerDbo majiangGamePlayerDbo) {
    ...
    public ShouxianMajiangJuPlayerResultVO(MajiangGamePlayerDbo majiangGamePlayerDbo) {
        playerId = majiangGamePlayerDbo.getPlayerId();
        nickname = majiangGamePlayerDbo.getNickname();
        headimgurl = majiangGamePlayerDbo.getHeadimgurl();
        huCount = 0;
