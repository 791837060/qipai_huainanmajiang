...
import com.anbang.qipai.shouxianmajiang.msg.channel.ShouxianMajiangGameSource;
...
@EnableBinding(ShouxianMajiangGameSource.class)
public class ShouxianMajiangGameMsgService {

	@Autowired
	private ShouxianMajiangGameSource shouxianMajiangGameSource;
	...
	public void gamePlayerLeave(MajiangGameValueObject majiangGameValueObject, String playerId) {
		...
		if (playerIsQuit) {
			...
			mo.setData(data);
            shouxianMajiangGameSource.shouxianMajiangGame().send(MessageBuilder.withPayload(mo).build());
		}
	}
