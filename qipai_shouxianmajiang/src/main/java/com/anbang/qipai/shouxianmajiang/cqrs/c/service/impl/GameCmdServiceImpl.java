...
import com.anbang.qipai.shouxianmajiang.cqrs.c.domain.MajiangGame;
...
//
//    @Override
//    public MajiangGameValueObject newMajiangGamePlayerLeaveAndQuit(String gameId, String playerId, Integer panshu, Integer renshu,Double difen, Integer powerLimit, OptionalPlay optionalPlay, MajiangGameQueryService gameQueryService, ShouxianMajiangGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
//        GameServer gameServer = singletonEntityRepository.getEntity(GameServer.class);
//        MajiangGame newGame = new MajiangGame();
//        newGame.setPanshu(panshu);
//        newGame.setRenshu(renshu);
...
//    }
    ...
    public List<PanActionFrame> getPanActionFrame(String gameId) throws Exception {
        GameServer gameServer = singletonEntityRepository.getEntity(GameServer.class);
        MajiangGame majiangGame = (MajiangGame) gameServer.findGame(gameId);
        Pan currentPan = majiangGame.getJu().getCurrentPan();
