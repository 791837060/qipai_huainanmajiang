...
public class MajiangHistoricalJuResult {
	...
	private List<ShouxianMajiangJuPlayerResultMO> playerResultList;
	...
	public MajiangHistoricalJuResult(JuResultDbo juResultDbo, MajiangGameDbo majiangGameDbo) {
		...
		ShouxianMajiangJuResult fangpaoMajiangJuResult = juResultDbo.getJuResult();
		...
		if (fangpaoMajiangJuResult.getPlayerResultList() != null) {
			fangpaoMajiangJuResult.getPlayerResultList().forEach((juPlayerResult) -> playerResultList.add(new ShouxianMajiangJuPlayerResultMO(juPlayerResult, majiangGameDbo.findPlayer(juPlayerResult.getPlayerId()))));
		} else {
			majiangGameDbo.getPlayers().forEach((majiangGamePlayerDbo) -> playerResultList.add(new ShouxianMajiangJuPlayerResultMO(majiangGamePlayerDbo)));
		}
	}
	...
	public List<ShouxianMajiangJuPlayerResultMO> getPlayerResultList() {
		return playerResultList;
	}

	public void setPlayerResultList(List<ShouxianMajiangJuPlayerResultMO> playerResultList) {
