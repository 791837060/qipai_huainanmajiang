...
public class PaodekuaiYaPaiSolutionsTipsFilter implements YaPaiSolutionsTipsFilter {
    ...
    public List<DaPaiDianShuSolution> filter(List<DaPaiDianShuSolution> YaPaiSolutions, Map<Integer, PukePai> allShoupai, boolean yapai) {
        ...
        LinkedList<DaPaiDianShuSolution> noWangSandaiyiSolutionList = new LinkedList<>();
            ...
            for (DaPaiDianShuSolution solution : noLaiziSolutionList) {
                ...
                if (dianshuZu instanceof SidaisanDianShuZu) {
                    ...
                    if (sidaisanSolutionList.isEmpty()) {
                        ...
                        int i = 0;
                        while (i < length) {
                            SidaisanDianShuZu tempDianshuzu = (SidaisanDianShuZu) sidaisanSolutionList.get(i).getDianShuZu();
                            if (tempDianshuzu.getDanpaiDianShu().compareTo(dianShu) > 0) {
                ...
                if (dianshuZu instanceof SandaiyiDianShuZu) {
                    SandaiyiDianShuZu sandaierDianShuZu = (SandaiyiDianShuZu) dianshuZu;
                    DianShu dianshu = sandaierDianShuZu.getSanzhangDianShuArray()[0];
                    if (dianshuCountArray[dianshu.ordinal()] == 3) { // 取只有三张牌的牌组
                        if (noWangSandaiyiSolutionList.isEmpty()) {
                            noWangSandaiyiSolutionList.add(solution);
                        } else {
                            int length = noWangSandaiyiSolutionList.size();
                            int i = 0;
                            while (i < length) {
                                SandaiyiDianShuZu tempDianshuzu = (SandaiyiDianShuZu) noWangSandaiyiSolutionList.get(i).getDianShuZu();
                                if (tempDianshuzu.getSanzhangDianShuArray()[0].compareTo(sandaierDianShuZu.getSanzhangDianShuArray()[0]) > 0) {
                                    noWangSandaiyiSolutionList.add(i, solution);
                                    break;
                                }
                                if (i == length - 1) {
                                    noWangSandaiyiSolutionList.add(solution);
                ...
                if (dianshuZu instanceof SandaiyiDianShuZu) {
                    ...
                    if (dianshuCountArray[dianshu.ordinal()] == 3) { // 取只有三张牌的牌组
                        if (noWangSandaiyiSolutionList.isEmpty()) {
                            ...
                            while (i < length) {
                                SandaiyiDianShuZu tempDianshuzu = (SandaiyiDianShuZu) noWangSandaiyiSolutionList.get(i).getDianShuZu();
                                int compare = tempDianshuzu.getSanzhangDianShuArray()[0].compareTo(sandaierDianShuZu.getSanzhangDianShuArray()[0]);
                                if (compare > 0) {
                                    noWangSandaiyiSolutionList.add(i, solution);
                                    break;
                                } else if (compare == 0) {
        ...
        filtedSolutionList.addAll(noWangSandaiyiSolutionList);
        ...
        filtedSolutionList.addAll(sidaisanSolutionList);
