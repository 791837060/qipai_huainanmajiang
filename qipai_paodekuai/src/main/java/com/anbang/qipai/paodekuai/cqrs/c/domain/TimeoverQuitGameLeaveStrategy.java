...
public class TimeoverQuitGameLeaveStrategy implements GameLeaveStrategy {
    ...
    private PukeGameQueryService gameQueryService;
    ...
    public TimeoverQuitGameLeaveStrategy(long overtime, PukeGameQueryService gameQueryService, PaodekuaiGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
            ...
            new Thread(() -> {
                try {
                    ...
                    if (leaveTime != null && System.currentTimeMillis() - leaveTime >= overtime) {
                        ...
                        PukeGameValueObject pukeGameValueObject = game.toValueObject();
                        gameQueryService.leaveGame(pukeGameValueObject);
