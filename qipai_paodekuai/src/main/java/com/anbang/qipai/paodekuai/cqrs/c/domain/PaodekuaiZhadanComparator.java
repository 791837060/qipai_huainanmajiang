...
public class PaodekuaiZhadanComparator implements ZhadanComparator {
    ...
    public int compare(ZhadanDianShuZu zhadan1, ZhadanDianShuZu zhadan2) {
        // 有aaa炸弹时
        if (zhadan1 instanceof ABoomDianShuZu || zhadan1 instanceof SanAJiaYiBoomDianShuZu) {
            return 1;
        }
        if (zhadan2 instanceof ABoomDianShuZu || zhadan2 instanceof SanAJiaYiBoomDianShuZu) {
            return -1;
        }
    ...
    private static DianShu getDianShu(ZhadanDianShuZu zhadanDianShuZu) {
        ...
        if (zhadanDianShuZu instanceof SanBoomDianShuZu) {
            SanBoomDianShuZu danGeZhadan = (SanBoomDianShuZu) zhadanDianShuZu;
            dianShu = danGeZhadan.getDianShu();
        }
        if (zhadanDianShuZu instanceof SanSanJiaYiBoomDianShuZu) {
            SanSanJiaYiBoomDianShuZu danGeZhadan = (SanSanJiaYiBoomDianShuZu) zhadanDianShuZu;
            dianShu = danGeZhadan.getDianShu();
        }
