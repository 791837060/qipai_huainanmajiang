...
public class GuandanJuPlayerResultMO {
	...
	public GuandanJuPlayerResultMO(PukeGamePlayerDbo playerDbo) {
	...
	public GuandanJuPlayerResultMO(GuandanJuPlayerResult juPlayerResult, PukeGamePlayerDbo playerDbo) {
		playerId = playerDbo.getPlayerId();
		nickname = playerDbo.getNickname();
		headimgurl = playerDbo.getHeadimgurl();
