...
public class TimeoverQuitGameLeaveStrategy implements GameLeaveStrategy {
    ...
    public TimeoverQuitGameLeaveStrategy(long overtime, PukeGameQueryService gameQueryService, GuandanGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
