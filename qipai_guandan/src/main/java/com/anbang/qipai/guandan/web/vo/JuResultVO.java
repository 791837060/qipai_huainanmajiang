...
public class JuResultVO {
	...
	private List<GuandanJuPlayerResultVO> playerResultList;
	...
	public JuResultVO(JuResultDbo juResultDbo, PukeGameDbo pukeGameDbo) {
		...
		if (juResult.getPlayerResultList() != null) {
			juResult.getPlayerResultList().forEach((juPlayerResult) -> playerResultList.add(new GuandanJuPlayerResultVO(juPlayerResult, pukeGameDbo.findPlayer(juPlayerResult.getPlayerId()))));
		} else {
			pukeGameDbo.getPlayers().forEach((pukeGamePlayerDbo) -> playerResultList.add(new GuandanJuPlayerResultVO(pukeGamePlayerDbo)));
		}
	}
	...
	public List<GuandanJuPlayerResultVO> getPlayerResultList() {
		return playerResultList;
	}

	public void setPlayerResultList(List<GuandanJuPlayerResultVO> playerResultList) {
