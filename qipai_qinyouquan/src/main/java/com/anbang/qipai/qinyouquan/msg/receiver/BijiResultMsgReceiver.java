...
import com.anbang.qipai.qinyouquan.msg.sink.BijiResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.puke.BijiJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.puke.BijiPanPlayerResult;
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new BijiPanPlayerResult((Map) panPlayerResult)));
