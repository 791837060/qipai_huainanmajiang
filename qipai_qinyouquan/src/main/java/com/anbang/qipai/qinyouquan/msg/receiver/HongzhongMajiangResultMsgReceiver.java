...
import com.anbang.qipai.qinyouquan.msg.sink.HongzhongMajiangResultSink;
import com.anbang.qipai.qinyouquan.plan.bean.LianmengWanfa;
import com.anbang.qipai.qinyouquan.plan.bean.PayForContribution;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.HongzhongMajiangJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.HongzhongMajiangPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.hongzhongMajiang);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                HongzhongMajiangJuPlayerResult pr = new HongzhongMajiangJuPlayerResult((Map) juPlayerResult);
