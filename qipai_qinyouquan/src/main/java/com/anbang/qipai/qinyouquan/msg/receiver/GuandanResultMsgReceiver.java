...
import com.anbang.qipai.qinyouquan.msg.sink.GuandanResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.puke.GuandanJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.puke.GuandanPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.guandan);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                GuandanJuPlayerResult pr = new GuandanJuPlayerResult((Map) juPlayerResult);
            ...
            if (gid != null) {
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList.add(new GuandanPanPlayerResult((Map) panPlayerResult)));
