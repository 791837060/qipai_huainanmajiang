...
import com.anbang.qipai.qinyouquan.msg.sink.GaoyouMajiangResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.GaoyouMajiangJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.GaoyouMajiangPanPlayerResult;
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new GaoyouMajiangPanPlayerResult((Map) panPlayerResult)));
