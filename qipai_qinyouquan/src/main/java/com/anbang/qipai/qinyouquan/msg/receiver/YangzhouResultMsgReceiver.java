...
import com.anbang.qipai.qinyouquan.msg.sink.YangzhouMajiangResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.YangzhouMajiangJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.YangzhouMajiangPanPlayerResult;
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new YangzhouMajiangPanPlayerResult((Map) panPlayerResult)));
