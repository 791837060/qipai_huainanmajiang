...
public class GameTableVO {
    ...
    private GameHistoricalJuResult playerResultList;

    public GameTable getGameTables() {
        return gameTables;
    }

    public void setGameTables(GameTable gameTables) {
        this.gameTables = gameTables;
    }

    public GameHistoricalJuResult getPlayerResultList() {
        return playerResultList;
    }

    public void setPlayerResultList(GameHistoricalJuResult playerResultList) {
