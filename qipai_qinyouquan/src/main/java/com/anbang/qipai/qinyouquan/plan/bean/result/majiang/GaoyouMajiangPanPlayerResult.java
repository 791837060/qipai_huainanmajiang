...
public class GaoyouMajiangPanPlayerResult implements GamePanPlayerResult {
    private String playerId;// 玩家id
    private String nickname;// 玩家昵称
    private double score;// 一盘总分

    public GaoyouMajiangPanPlayerResult() {

    }

    public GaoyouMajiangPanPlayerResult(Map panPlayerResult) {
