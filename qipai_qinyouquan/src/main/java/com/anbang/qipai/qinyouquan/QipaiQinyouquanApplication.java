package com.anbang.qipai.qinyouquan;

import com.anbang.qipai.qinyouquan.conf.FilePathConfig;
import com.anbang.qipai.qinyouquan.cqrs.c.repository.SingletonEntityFactoryImpl;
import com.anbang.qipai.qinyouquan.cqrs.c.service.disruptor.CoreSnapshotFactory;
import com.anbang.qipai.qinyouquan.cqrs.c.service.disruptor.ProcessCoreCommandEventHandler;
import com.anbang.qipai.qinyouquan.cqrs.c.service.disruptor.SnapshotJsonUtil;
import com.anbang.qipai.qinyouquan.init.InitProcessor;
...
@EnableFeignClients
@EnableScheduling
public class QipaiQinyouquanApplication {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(QipaiQinyouquanApplication.class, args);
    }
