...
import com.anbang.qipai.qinyouquan.msg.sink.TianchangxiaohuaResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.TianchangxiaohuaJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.TianchangxiaohuaPanPlayerResult;
            ...
            if (gid != null && dyjId != null && dthId != null) {
                ...
                if (table != null) {
                    if (!table.isJuFinish()) {
                        ...
                        pukeHistoricalResult.setGame(Game.tianchangxiaohua);
                        ...
                        if (playerList != null) {
                            ...
                            for (Object juPlayerResult : (List) playerList) {
                                ...
                                TianchangxiaohuaJuPlayerResult pr = new TianchangxiaohuaJuPlayerResult((Map) juPlayerResult);
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new TianchangxiaohuaPanPlayerResult((Map) panPlayerResult)));
