...
import com.anbang.qipai.qinyouquan.msg.sink.MaanshanMajiangResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.MaanshanMajiangJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.MaanshanMajiangPanPlayerResult;
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new MaanshanMajiangPanPlayerResult((Map) panPlayerResult)));
