...
import com.anbang.qipai.qinyouquan.msg.sink.TaizhouMajiangResultSink;
...
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.TaizhouMajiangJuPlayerResult;
import com.anbang.qipai.qinyouquan.plan.bean.result.majiang.TaizhouMajiangPanPlayerResult;
                ...
                if (table != null) {
                    ...
                    if (playerList != null) {
                        ...
                        ((List) playerList).forEach((panPlayerResult) -> panPlayerResultList
                                .add(new TaizhouMajiangPanPlayerResult((Map) panPlayerResult)));
