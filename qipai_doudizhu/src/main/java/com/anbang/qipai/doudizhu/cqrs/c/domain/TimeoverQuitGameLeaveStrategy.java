...
public class TimeoverQuitGameLeaveStrategy implements GameLeaveStrategy {
    ...
    public TimeoverQuitGameLeaveStrategy(long overtime, PukeGameQueryService gameQueryService, DoudizhuGameMsgService gameMsgService, GamePlayWsNotifier wsNotifier) {
